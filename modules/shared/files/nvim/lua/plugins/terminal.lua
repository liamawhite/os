return {
    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader>gg", "<cmd>lua _lazygit_toggle()<CR><C-\\><C-n>i", { noremap = true, silent = true, })
            vim.keymap.set("t", "<leader>gg", "<C-\\><C-n><cmd>lua _lazygit_toggle()<CR>", { noremap = true, silent = true })
