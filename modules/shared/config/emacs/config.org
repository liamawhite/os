...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Liam White"
    user-mail-address "liamawhite@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/liamawhite/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/liamawhite/bin" "/profile/bin" "/Users/liamawhite/.npm-packages/bin" "/Users/liamawhite/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
