...
(use-package doom-modeline
  ...
  ;; Custom Evil state display
  (defun my/doom-modeline-evil-state ()
    "Custom Evil state display with angle brackets."
    (when (bound-and-true-p evil-local-mode)
      (let ((state (cond
                    ...
                    (t "<UNKNOWN>"))))
        (propertize state 'face 'doom-modeline-evil-normal-state))))
  
  (advice-add 'doom-modeline-segment--modals :override #'my/doom-modeline-evil-state)
)
